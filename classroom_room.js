  ...
  var firebaseConfig = {
      ...
      databaseURL: "https://kwitter-70a9a-default-rtdb.firebaseio.com",
...
function addRoom() {
      ...
      localStorage.setItem("room_name", room_name); window.location = "classroom_page.html";
}
...
function redirectToRoomName(name) {
      ...
      window.location = "classroom_page.html";
}
